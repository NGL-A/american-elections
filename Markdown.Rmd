---
title: "Variable analisys over USA Presidential Elections"
...
The transport data is correlated to the states geographical morphology: outside big cities distances become huge so the use of a car by over the 90% of the population (Drive and Carpool) is justified.
...
As suspected the distribution is not the same; the democratic counties have generally more inhabitants and the biggest counties are all democratic.

&ensp;&ensp;

Now we want to understand how the US population is distributed over the territory. With the help of some maps is easier to visualize the geographic areas with more ethnic diversity as well as other data as density of population and unemployment.
